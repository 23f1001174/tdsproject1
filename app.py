...
function_definitions_llm = [
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "file_path": {"type": "string", "description": "Path of the file to modify in the repo."},
                "file_content": {"type": "string", "description": "New content to write to the file."}
            },
    ...
    },
    {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "audio_path": {"type": "string", "description": "Path to the MP3 file."},
                "language": {"type": "string", "description": "Language code (e.g., 'en' for English, 'es' for Spanish)."}
            },
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "filter_column": {"type": "string", "description": "Column name to apply the filter on."},
